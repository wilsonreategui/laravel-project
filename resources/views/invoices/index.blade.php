        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div style="display: flex; justify-content: center; padding-top: 20px; ">
                    <a href="{{route('invoices.create')}}" style="background: #6875F5; padding: 10px; color: white; border-radius: 15px;">New Invoice</a>
                </div>
                                        ...
                                        <td class=" text-sm border">
                                            <div class="justify-center my-8 select-none flex">
                                                @if($invoice->status == "Active")
                                                    <a href="{{route('invoices.edit', ['invoice' => $invoice])}}" class="px-3 ">Edit</a>
                                                @else
                                                    <a href="{{route('invoices.edit', ['invoice' => $invoice])}}" class="px-3 ">Review</a>
                                                @endif
                                            </div>
                                        </td>
                                    </tr>
